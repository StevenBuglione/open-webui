...
# Key vault created manually to avoid throttling during proof-of-concept; skip managing it via Terraform for now.
# module "secrets" {
...
module "scim" {
  count  = 0 # temporarily disabled until tenant supports SCIM template
  source = "../../modules/scim"
